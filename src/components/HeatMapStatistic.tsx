...
export function HeatMapStatistic({
	app,
	settings,
}: {
	app: App;
	...
	const [selectedExercises, setSelectedExercises] = useState<Record<
		string,
		FrontMatterCache[]
	> | null>(null);
	...
	useEffect(() => {
		...
		setSelectedExercises(
			sortedExercises as Record<string, FrontMatterCache[]>
		);
	}, [selected]);
	...
	return (
		<div>
			...
			<div className={"flex-col gap-1"}>
				...
				{!selected && (
					<small>Select a day to get detailed information</small>
				)}
				<div className={"flex gap-1 align-center"}>
					<div
						className={"box"}
